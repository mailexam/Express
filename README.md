...
Minimal [Express](https://expressjs.com/) example that sends test mail through [Mailexam](https://mailexam.io/) SMTP via [Nodemailer](https://nodemailer.com/).
...
- `express.json()` is registered before routes in `server.js`.
...
- [Node.js reference implementation](https://github.com/mailexam/Node.js) — Nodemailer without a framework
- [Fastify](https://github.com/mailexam/Fastify), [Hapi](https://github.com/mailexam/Hapi), [NestJS](https://github.com/mailexam/NestJS), [Next.js](https://github.com/mailexam/Next.js), [BullMQ](https://github.com/mailexam/BullMQ) — other Node.js frameworks
